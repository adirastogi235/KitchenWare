  ...
  if (cart.items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <Link
          href="/products"
          className="inline-block px-6 py-3 rounded-xl bg-[var(--color-primary)] text-[#1a1410] font-semibold"
        >
          Browse Products
        </Link>
      </div>
            ...
            <div className="bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] p-6 sticky top-24">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className={shipping === 0 ? "text-[var(--color-primary)]" : ""}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 rounded-xl bg-[var(--color-primary)] text-[#1a1410] font-semibold text-lg hover:shadow-xl hover:shadow-yellow-400/30 transition-all duration-300 hover:-translate-y-0.5 disabled:opacity-50 active:scale-[0.98]"
              >
