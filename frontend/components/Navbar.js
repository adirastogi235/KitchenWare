        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-1.5">
            ...
            {user?.is_admin && (
              <Link
                href="/admin"
                className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] text-sm font-medium hover:bg-[var(--color-primary)]/20 transition-colors duration-200"
              >
        ...
        {mobileOpen && (
          <div className="md:hidden pb-4 border-t border-[var(--color-border)] mt-2 pt-3 space-y-1">
            ...
            {user?.is_admin && (
              <Link
                href="/admin"
                className="block px-4 py-2.5 rounded-xl text-[var(--color-primary)] hover:bg-[var(--color-primary)]/10 transition-colors font-medium"
                onClick={() => setMobileOpen(false)}
              >
                Admin Dashboard
              </Link>
